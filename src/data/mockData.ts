...
export const mockMarketplaceItems: MarketplaceItem[] = [
  ...
  },
  {
    ...
    description: 'Tools for extracting and processing structured data',
    category: 'Data',
    tags: ['data-extraction', 'processing', 'automation'],
    provider: 'DataTech',
    pricing: 'Paid',
    rating: 4.8,
    downloads: 980,
  ...
  },
  {
    ...
    category: 'Healthcare',
    tags: ['healthcare', 'medical', 'assistant'],
    provider: 'HealthAI',
    pricing: 'Paid',
    rating: 4.7,
    downloads: 750,
  ...
  },
  {
    ...
    description: 'Template for financial data analysis and reporting',
    category: 'Finance',
  ...
  },
  {
    ...
    description: 'Specialized model for document processing and extraction',
    category: 'Document',
  ...
  },
  {
    ...
    description: 'Agent for analyzing and extracting information from legal documents',
    category: 'Legal',
